package com.gicheol.riverpodfreezedgenerator.converter.constant
...
enum class WidgetType(
    ...
    fun getBuildMethodSignature(): String = when (this) {
        ConsumerWidget, ConsumerStatefulWidget -> "Widget build(BuildContext context, WidgetRef ref)"
        StatelessWidget, StatefulWidget -> "Widget build(BuildContext context)"
    }
}