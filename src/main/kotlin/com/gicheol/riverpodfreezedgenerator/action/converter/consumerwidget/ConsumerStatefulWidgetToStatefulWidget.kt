...
class ConsumerStatefulWidgetToStatefulWidget : PsiElementBaseIntentionAction(), IntentionAction {
    ...
    override fun invoke(project: Project, editor: Editor, element: PsiElement) {
        WriteCommandAction.runWriteCommandAction(project) {
            WidgetConverter.convertConsumerStatefulWidgetToStatefulWidget(project, editor, element)
        }
    }
