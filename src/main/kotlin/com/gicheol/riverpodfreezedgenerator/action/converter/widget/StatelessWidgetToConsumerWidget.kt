...
class StatelessWidgetToConsumerWidget : PsiElementBaseIntentionAction(), IntentionAction {
    ...
    override fun invoke(project: Project, editor: Editor, element: PsiElement) {
        WriteCommandAction.runWriteCommandAction(project) {
            WidgetConverter.convertStatelessWidgetToConsumerWidget(project, editor, element)
        }
    }
